...
-- Autostart programs with Awesome
...
awful.screen.connect_for_each_screen(function(s)
    ...
    local tags = { "top", "www", "tty", "fun", "irc" }
    local suit = awful.layout.suit
    local layouts = { suit.tile, suit.tile, suit.tile, suit.magnifier, suit.tile }
...
-- {{{ Mouse bindings
root.buttons(awful.button({ }, 3, function () mainmenu:toggle() end))
-- }}}
...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey }, "r",
              function ()
                  awful.spawn("rofi -modes 'drun,run,window' -show drun")
              end,
    ...
    -- Floating clients.
    {
        rule_any = {
            ...
            class = {
                ...
                "MessageWin",  -- kalarm.
                "Sxiv",
                "Tor Browser", -- Needs a fixed window size.
                "Wpa_gui",
                "veromix",
                "xtightvncviewer"
            },
